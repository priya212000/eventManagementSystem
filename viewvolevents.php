...
echo "<h3>You can view  volunteering events now |".$_SESSION['name']."</h3> ";}?></th>
<th>
<a href="welcomevolunteer.php"><h3>Back</h3></a>
</th>
</tr>
</table>
<div>
...
{  $a=$row['event_id'];
  ...
  $sp=$r['sponser_name'];
  $id=$_SESSION['id'];
  $q=mysqli_query($con,"SELECT * FROM volunteering_events where event_id=$a and volunteer_id=$id") or die("Qyery not obtained l");
  if($q)
  $r= mysqli_fetch_array($q);
if(!$r)continue;
echo "<tr>";
